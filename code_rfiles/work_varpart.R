...
mod_tPL <- varpart(Yt_PL, ~ ., Xs_PL[,1], Xs_PL[,2] , data = Xe_PL, transfo="log")
    ...
    p1 <- plot(mod_tPL, bg = c("hotpink","skyblue", "burlywood"),Xnames=c('Plant', 'Month','Latitude'))
...
mod_gPL <- varpart(Yg_PL, ~ ., Xs_PL[,1], Xs_PL[,2] , data=Xe_PL, transfo="log")
   ...
   p2<-  plot(mod_gPL, bg = c("hotpink","skyblue", "burlywood"),Xnames=c('Plant', 'Month','Latitude'))
...
mod_tST <- varpart(Yt_ST, ~ ., Xs_ST[,1], Xs_ST[,2] , data=Xe_ST, transfo="log")
    ...
    plot(mod_tST, bg = c("hotpink","skyblue", "burlywood"), Xnames=c('Plant', 'Month','Latitude'))
...
mod_gST <- varpart(Yg_ST, ~ ., Xs_ST[,1], Xs_ST[,2] , data=Xe_ST, transfo="log")
    ...
    plot(mod_gST, bg = c("hotpink","skyblue", "burlywood"), Xnames=c('Plant', 'Month','Latitude'))

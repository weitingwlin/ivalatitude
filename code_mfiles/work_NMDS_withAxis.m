...
guildname =Tguildname{2:11,2}';
 ...
 [h1] =  plot_NMDS2(mds_2.scores, vec([1:7 9],:), ...
                                   ...
                                   temp, 2);
            s = 1; mytext(vec(s,1), vec(s,2), guildname(s),14, 8) ;                   
            s = 2; mytext(vec(s,1), vec(s,2), guildname(s),14, 2) ;   
            s = 7; mytext(vec(s,1), vec(s,2), guildname(s),14, 9) ;     
            s = 6; mytext(vec(s,1), vec(s,2), guildname(s),14, 6) ; 
